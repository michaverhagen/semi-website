...
It is important to remember that raw data is never shared in SeMI use cases. Only the metadata that the raw data represents is used. For more information on this topic, please refer to our [brief]({{ site.baseurl }}/blog/data-usage-and-compliancy/) on why your data is safe.
